...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" class="needs-validation" action="{{ route('clients.update', $client->id) }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('put')
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check form-switch form-switch-success">
                                <input class="form-check-input" type="checkbox" name="active" id="activeSwitch" {{ $client->status == 'active' ? 'checked' : '' }}>
