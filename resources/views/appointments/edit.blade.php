    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" action="{{ route('appointments.update', $appointment->id) }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select 
                                    ...
                                    required
                                >
                                    <option value="{{ isset($appointment->users) ? $appointment->organizer_id : '' }}">{{ isset($appointment->users) ? $appointment->users->first_name . ' ' . $appointment->users->last_name : 'N/A' }}</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select 
                                    ...
                                    required
                                >
                                    <option value="{{ isset($appointment->clients) ? $appointment->client_id : '' }}">{{ isset($appointment->clients) ? $appointment->clients->first_name . ' ' . $appointment->clients->last_name : 'N/A' }}</option>
